    ...
    <Link to={`/video/${video?.videoId}`}>
      <div className="flex flex-col md:flex-row mb-8 md:mb-3 lg:hover:bg-white/[0.1] rounded-xl md:p-4 ">
        ...
        <div className='flex flex-col ml-4 md:ml-6 mt-4 md:mt-0 overflow-hidden'>
          <span className='text-lg font-semibold md:text-2xl text-white line-clamp-2'>
            {video?.title}
          </span>
          <span className='empty:hidden text-sm text-white/[0.7] line-clamp-1 md:line-clamp-2 md:pr-24 md:my-4'>
